...
class TestJDMatchModels:
    ...
    def test_jd_match_request_validation(self):
        """测试请求模型验证"""
        from app.schemas.resume.jd_schemas import JDMatchRequest
    ...
    def test_jd_match_result_validation(self):
        """测试结果模型验证"""
        from app.schemas.resume.jd_schemas import JDMatchResult
    ...
    def test_jd_match_response_validation(self):
        """测试响应模型验证"""
        from app.schemas.resume.jd_schemas import JDMatchResponse, JDMatchResult
