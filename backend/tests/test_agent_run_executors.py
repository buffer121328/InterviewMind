...
async def test_job_assets_executor_defers_job_status_for_agent_run_transaction(monkeypatch):
    ...
    monkeypatch.setattr("app.services.jobs.job_asset_orchestrator.generate_assets", fake_generate_assets)
    monkeypatch.setattr("app.repositories.jobs.job_capture_repo.get_job_capture_repo", lambda: FakeJobRepo())
