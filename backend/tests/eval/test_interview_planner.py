...
数据来源: tests/datasets/interview_golden.json
...
class TestInterviewPlanQuality:
    ...
    @pytest.mark.skipif(not _GOLDEN_CASES, reason="Golden dataset not available (tests/datasets/interview_golden.json)")
