...
from integrations.boss.apply_approval import ApprovalError, apply_approval_registry, is_allowed_apply_url
...
async def execute_apply_send(
    ...
    try:
        ...
        if not result.get("success"):
            ...
            from integrations.boss.rate_limiter import record_failure
        ...
        from integrations.boss.rate_limiter import record_success
