...
class ChangeItem(BaseModel):
    """变更项"""
    change_type: str = Field(description="变更类型: polish/restructure/suggest_addition/fact_inference")
    section_name: str = Field(description="部分名称")
    original_text: Optional[str] = Field(default=None, description="原文")
    optimized_text: str = Field(description="优化后的内容")
