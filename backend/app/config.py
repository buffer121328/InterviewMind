...
class AppSettings(BaseSettings):
    ...
    llm_request_timeout_seconds: int = Field(default=90, ge=1, le=600)
    ...
    interview_report_min_output_tokens: int = Field(default=6000, ge=512, le=16_000)
    interview_report_output_tokens_per_question: int = Field(default=400, ge=1, le=2_000)
    interview_report_max_output_tokens: int = Field(default=12_000, ge=512, le=16_000)
    interview_report_reviewer_max_output_tokens: int = Field(default=3000, ge=512, le=8_000)
    ...
    interview_report_task_timeout_per_question_seconds: int = Field(default=30, ge=1, le=120)
    interview_report_task_timeout_cap_seconds: int = Field(default=1200, ge=10, le=1800)
    interview_report_request_timeout_seconds: int = Field(default=120, ge=1, le=600)
    interview_report_request_timeout_per_question_seconds: int = Field(default=3, ge=1, le=60)
    interview_report_request_timeout_cap_seconds: int = Field(default=180, ge=1, le=600)
