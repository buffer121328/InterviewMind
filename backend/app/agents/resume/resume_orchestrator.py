...
from app.agents.resume.resume_pipeline_graph import build_resume_graph
from app.agents.resume.resume_pipeline_quality import (
...
async def _run_pipeline(
    ...
    """执行不含观测上下文的流水线主体。"""
    from app.infrastructure.memory.memory import get_checkpointer
