...
async def _retrieve_queries(
    *,
    ...
    from app.infrastructure.rag.embedding_service import generate_embedding
...
async def _retrieve_memory_evidences(
    *,
    ...
    from app.infrastructure.runtime.middleware.content_safety import contains_prompt_injection
