...
class WeaknessReportModel(Base):
    """SQLAlchemy 持久化模型，描述 `WeaknessReport` 的数据库字段、关系和约束；仓储层负责 owner 过滤、事务提交和敏感数据边界。"""
...
class QuestionBankItemModel(Base):
    """SQLAlchemy 持久化模型，描述 `QuestionBankItem` 的数据库字段、关系和约束；仓储层负责 owner 过滤、事务提交和敏感数据边界。"""
...
class QuestionBankImportModel(Base):
    """SQLAlchemy 持久化模型，描述 `QuestionBankImport` 的数据库字段、关系和约束；仓储层负责 owner 过滤、事务提交和敏感数据边界。"""
