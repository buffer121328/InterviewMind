...
class NextRoundRequest(BaseModel):
    ...
    max_questions: int | None = Field(default=None, ge=1, le=20)  # 本轮最多问题数（1-20）
...
async def list_sessions(
    ...
    Args:
        status: 按状态筛选（active/completed/archived，可选）。
        mode: 按模式筛选（mock，可选）。
