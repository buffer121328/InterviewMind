...
def _register_builtin_prompts() -> None:
    ...
    from app.prompts.interview import build_evaluating_prompt, build_opening_prompt, build_planner_prompt
    ...
    from app.prompts.voice import build_voice_system_prompt
