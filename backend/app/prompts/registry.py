...
def _register_builtin_prompts() -> None:
    ...
    from app.prompts.jobs import JOB_CARD_SCORING_PROMPT, build_job_card_scoring_prompt
    ...
    from app.prompts.voice import VOICE_SYSTEM_PROMPT, build_voice_system_prompt
