...
def get_mem0_config() -> Optional[dict]:
    ...
    llm_config = {
        ...
        "config": {
            "model": _env("MEM0_LLM_MODEL", "deepseek-chat"),
            "api_key": _env("MEM0_LLM_API_KEY"),
            "openai_base_url": _env("MEM0_LLM_BASE_URL", "https://api.deepseek.com/v1"),
            "temperature": 0.1,
        },
    }
    ...
    embedder_config = {
        ...
        "config": {
            "model": _env("MEM0_EMBEDDER_MODEL", "text-embedding-3-small"),
            "api_key": _env("MEM0_EMBEDDER_API_KEY"),
