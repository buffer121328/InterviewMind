...
def _build_resume_analyzer(**kwargs: Any) -> Any:
    ...
    Args:
        **kwargs: 调用方传入的 `kwargs` 参数。
    """
    from app.agents.resume.resume_analyzer_graph import build_resume_analyzer_graph
...
def _build_resume_generator(**kwargs: Any) -> Any:
    ...
    Args:
        **kwargs: 调用方传入的 `kwargs` 参数。
    """
    from app.agents.resume.resume_generation_graph import build_resume_generation_graph
