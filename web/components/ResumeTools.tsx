...
import { ProductionHistoryEvaluationPanel } from "./evaluations/ProductionHistoryEvaluationPanel";
...
export function ResumeTools({ apiConfig, resumeContent, jobContext, generationSessionId, onGenerationSessionConsumed, onResumeChange, onOpenSession }: ResumeToolsProps) {
    ...
    return <div className="flex min-h-full flex-col gap-6">
        ...
        {resultId != null && <ProductionHistoryEvaluationPanel capability={currentResumeResult?.result_type === 'analyze' ? 'resume_analyzer' : 'resume_optimizer'} sourceId={String(resultId)} />}
