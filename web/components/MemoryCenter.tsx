            ...
            <section className="surface-panel p-5">
                <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
                    <div>
                        ...
                        <p className="mt-1 text-xs leading-5 text-slate-500">查看 mem0 为当前用户保存的经历、偏好和面试上下文。删除操作直接作用于后端记忆库。</p>
                    </div>
                ...
                <section className="min-h-0 overflow-y-auto pr-1">
                    {loading ? (
                        ...
                        <div className="flex min-h-64 flex-col items-center justify-center rounded-2xl border border-dashed border-slate-300 bg-white text-center">
                            ...
                            <p className="mt-1 max-w-md text-xs leading-5 text-slate-500">完成面试并启用 mem0 后，系统会把可复用的候选人信息沉淀到这里。</p>
                        </div>
                    ) : (
