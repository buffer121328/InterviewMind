...
// 定义视图类型，包含 'landing'
type ViewType = "landing" | "interview" | "resume" | "guide" | "applications" | "questionbank";
...
export default function InterviewPage() {
  ...
  useEffect(() => {
    ...
    if (savedTab && (savedTab === "resume" || savedTab === "interview" || savedTab === "landing" || savedTab === "applications" || savedTab === "questionbank")) {
